...
namespace ht4c { namespace Odbc {
	...
	/// <summary>
	/// Represents a Hypertable asynchronous mutator, using the Odbc API.
	/// </summary>
	/// <seealso cref="ht4c::Common::TableMutator"/>
	class OdbcAsyncTableMutator : public Common::AsyncTableMutator {

		public:

			/// <summary>
			/// Creates a new OdbcAsyncTableMutator instance.
			/// </summary>
			/// <param name="tableMutator">Odbc mutator</param>
			/// <returns>New OdbcAsyncTableMutator instance</returns>
			...
			/// <summary>
			/// Destroys the OdbcAsyncTableMutator instance.
			/// </summary>
			virtual ~OdbcAsyncTableMutator( );
		...
		private:
			...
			OdbcAsyncTableMutator( Db::MutatorAsyncPtr tableMutator );

			OdbcAsyncTableMutator( ) { }
			OdbcAsyncTableMutator( const OdbcAsyncTableMutator& ) { }
			OdbcAsyncTableMutator& operator = ( const OdbcAsyncTableMutator& ) { return *this; }
