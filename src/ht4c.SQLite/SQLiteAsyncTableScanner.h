...
namespace ht4c { namespace SQLite {
	...
	/// <summary>
	/// Represents a Hypertable asynchronous scanner, using the sqlite API.
	/// </summary>
	/// <seealso cref="ht4c::Common::AsyncTableScanner"/>
	class SQLiteAsyncTableScanner : public Common::AsyncTableScanner {

		public:

			/// <summary>
			/// Creates a new SQLiteAsyncTableScanner instance.
			/// </summary>
			/// <param name="tableScanner">SQLite scanner</param>
			/// <returns>New SQLiteAsyncTableScanner instance</returns>
			...
			/// <summary>
			/// Destroys the SQLiteAsyncTableScanner instance.
			/// </summary>
			virtual ~SQLiteAsyncTableScanner( );
		...
		private:
			...
			SQLiteAsyncTableScanner( Db::ScannerAsyncPtr tableScanner );

			SQLiteAsyncTableScanner( ) { }
			SQLiteAsyncTableScanner( const SQLiteAsyncTableScanner& ) { }
			SQLiteAsyncTableScanner& operator = ( const SQLiteAsyncTableScanner& ) { return *this; }
