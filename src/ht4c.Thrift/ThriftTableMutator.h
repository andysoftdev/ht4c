...
namespace ht4c { namespace Thrift {
	...
	/// <summary>
	/// Represents a Hypertable mutator, using the thrift API.
	/// </summary>
	/// <seealso cref="ht4c::Common::TableMutator"/>
	class ThriftTableMutator : public Common::TableMutator {

		public:

			/// <summary>
			/// Creates a new ThriftTableMutator instance.
			/// </summary>
