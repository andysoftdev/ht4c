...
namespace ht4c { namespace Hamster {
	...
	/// <summary>
	/// Represents a Hypertable asynchronous mutator, using the hamster API.
	/// </summary>
	/// <seealso cref="ht4c::Common::TableMutator"/>
	class HamsterAsyncTableMutator : public Common::AsyncTableMutator {

		public:

			/// <summary>
			/// Creates a new HamsterAsyncTableMutator instance.
			/// </summary>
			/// <param name="tableMutator">Hamster mutator</param>
			/// <returns>New HamsterAsyncTableMutator instance</returns>
		...
		private:
			...
			HamsterAsyncTableMutator( Db::MutatorAsyncPtr tableMutator );

			HamsterAsyncTableMutator( ) { }
			HamsterAsyncTableMutator( const HamsterAsyncTableMutator& ) { }
			HamsterAsyncTableMutator& operator = ( const HamsterAsyncTableMutator& ) { return *this; }
